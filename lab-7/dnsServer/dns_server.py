...
from utils.manageservice import log_info
                    ...
                    if b=='CNAME':
                        ...
                        try:
                            ...
                            for i in res_candidate:
                                ...
                                idis=abs(iloc[0]-loc[0])*abs(iloc[0]-loc[0])+abs(iloc[1]-loc[1])*abs(iloc[1]-loc[1])
                                rdis=abs(rloc[0]-loc[0])*abs(rloc[0]-loc[0])+abs(rloc[1]-loc[1])*abs(rloc[1]-loc[1])
                                if(idis<rdis):
                                    response_val=i
                        except:
